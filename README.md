...
These core plots provide a quick overview of the top striker candidates and key relationships in the data:
...
To provide deeper insight, the following plots show the distribution, spread, and ranking of key metrics across all candidates:
...
*See the [summary table](output/striker_summary_stats.csv) for more details on all candidates.*
